...
emailjs.init("aD6ULh43JeKRfQdGE");
...
function App() {
    ...
    if (formData.name && formData.email && formData.facilityName) {
      ...
      emailjs.send(
        ...
        'template_b3iz60m', 
        {
          ...
          currentAnnualFalls: formData.currentAnnualFalls,
          currentAnnualReadmissions: formData.currentAnnualReadmissions,
          currentTravelNurses: formData.currentTravelNurses
        }
      ).then(
        (result) => {
  ...
  const calculateSavings = (e: React.FormEvent) => {
    ...
    const fallsSavings = (parseInt(formData.currentAnnualFalls) || 0) * 64000 * 0.52;
    const readmissionsSavings = (parseInt(formData.currentAnnualReadmissions) || 0) * 15200 * 0.58;
    const nursingSavings = (parseInt(formData.currentTravelNurses) || 0) * 150 * 36 * 52 * 0.78;
      ...
      <div style={{ 
        ...
        <div style={{ 
          ...
          <div style={{ 
            ...
            <Activity style={{ color: "#4A5D4B", margin: "0 auto 16px" }} size={32} />
            <h3 style={{ color: "#3C4A3D", marginBottom: "8px" }}>Fall Prevention</h3>
          ...
          <div style={{ 
            ...
            <TrendingDown style={{ color: "#4A5D4B", margin: "0 auto 16px" }} size={32} />
            <h3 style={{ color: "#3C4A3D", marginBottom: "8px" }}>Reduce Readmissions</h3>
          ...
          <div style={{ 
            ...
            <DollarSign style={{ color: "#4A5D4B", margin: "0 auto 16px" }} size={32} />
            <h3 style={{ color: "#3C4A3D", marginBottom: "8px" }}>Staff Optimization</h3>
              ...
              <div style={{ marginTop: "32px" }}>
                ...
                <div style={{ 
                  ...
                  <div style={{ 
                    ...
                    <p style={{ color: "#3C4A3D", marginBottom: "8px" }}>Falls Prevention Savings</p>
                    <p style={{ 
                      fontSize: "24px",
                      fontWeight: "bold",
                      color: "#4A5D4B"
                  ...
                  <div style={{ 
                    ...
                    <p style={{ color: "#3C4A3D", marginBottom: "8px" }}>Readmission Reduction Savings</p>
                    <p style={{ 
                      fontSize: "24px",
                      fontWeight: "bold",
                      color: "#4A5D4B"
                  ...
                  <div style={{ 
                    ...
                    <p style={{ color: "#3C4A3D", marginBottom: "8px" }}>Travel/Agency Nurse Savings</p>
                    <p style={{ 
                      fontSize: "24px",
                      fontWeight: "bold",
                      color: "#4A5D4B"
                  ...
                  <div style={{ 
                    ...
                    <p style={{ color: "#3C4A3D", marginBottom: "8px" }}>Total Annual Savings</p>
                    <p style={{ 
                      fontSize: "28px",
                      fontWeight: "bold",
                      color: "#4A5D4B"
